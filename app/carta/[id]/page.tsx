      	...
      	<div>
        	...
        	{display.mana_cost ? (
          	<p className="mb-2">
            	...
            	<span className="font-mono">{display.mana_cost}</span>
          	</p>
        	) : null}
        	{display.type_line ? (
          	<p className="mb-2">
        	...
        	{display.oracle_text ? (
          	<p className="mb-4 text-sm bg-[#1E242B] p-3 rounded-lg whitespace-pre-wrap">
            	{display.oracle_text}
          	</p>
        	) : null}
          	...
          	<div className="mb-6">
            	...
            	<div className="flex gap-2 overflow-x-auto pb-2">
              	{prints.map((p) => {
                	...
                	const btnClass = `relative flex-shrink-0 w-20 aspect-[5/7] rounded border-2 overflow-hidden transition ${
                  	isSel
                    	? "border-[#FF4D1A]"
