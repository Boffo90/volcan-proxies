...
const FAQS = [
  ...
  },
  {
	...
	a: "Sí. Tenemos la sección /custom donde puedes subir imágenes JPG o PNG (máximo 5MB) y nosotros las imprimimos como carta. Útil para tokens custom, alters, basic lands con arte personalizado, etc. Hay un recargo extra por carta custom para cubrir el ajuste manual.",
  },
  {
